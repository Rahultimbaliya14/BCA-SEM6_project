        ...
        if not Customer.objects.filter(email=mail):
            if passw == cpass:
                if len(passw) >= 8:
                        if len(phone) == 10:
                            if verify:
                                 subject, from_email, to = 'Create Account', 'zoomanagmentsystem@gmail.com',mail
        ...
        if not uemail:
            ...
            if not len(pwd) < 8:
                if verify:
                      ...
                      subject, from_email, to = 'Forget Password', 'zoomanagmentsystem@gmail.com',emailr
                      text_content = 'This is an important message.'
...
def demail(request):
        ...
        if not id == "":
            ...
            otpd2 = str(otpd)
            print(rpwd,emailr,otpr2)
            subject, from_email, to = 'Unregister Account', 'zoomanagmentsystem@gmail.com',semail
            text_content = 'This is an important message.'
